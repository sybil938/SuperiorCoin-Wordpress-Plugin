...
class SuperiorCoin_Library
{
    ...
    /* 
     * The following functions can all be called to interact with the superiorcoin rpc wallet
    ...
    {
        // If I pass 1, it will be 0.00000001 SUP. Then
